...
from .tools import edit_content, get_overview, read_content, search_content
...
def create_server() -> Server:
    ...
    async def call_tool(name: str, arguments: dict) -> list[types.TextContent]:
        ...
        if name == "get_overview":
            result = get_overview(**arguments)
        elif name == "search_content":
            result = search_content(**arguments)
        elif name == "read_content":
            result = read_content(**arguments)
        elif name == "edit_content":
            result = edit_content(**arguments)
        else:
