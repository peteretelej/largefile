...
class TestDocumentationWorkflows:
    ...
    def test_ai_sdk_comparison(self):
        ...
        total_chat_matches = openai_results["total_matches"] + anthropic_results["total_matches"]
    ...
    def test_ml_framework_documentation_analysis(self):
        ...
        pytorch_async = search_content(str(pytorch_doc), "async", fuzzy=True, context_lines=2)
        fastapi_async = search_content(str(fastapi_doc), "async", fuzzy=True, context_lines=2)
        
        # At least one should have async content
        total_async_matches = pytorch_async["total_matches"] + fastapi_async["total_matches"]
    ...
    def test_nodejs_runtime_documentation(self):
        ...
        if module_results["total_matches"] > 0:
            ...
            content = read_content(str(nodejs_doc), line_num, mode="lines", context_lines=3)
